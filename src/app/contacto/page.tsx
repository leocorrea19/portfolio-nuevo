      ...
      <div className="w-full">
        <div className="text-center mb-12">
          ...
          <p className="mt-6 text-xl text-muted-foreground max-w-2xl mx-auto">
            ¿Tienes un proyecto en mente o buscas sumar un desarrollador proactivo a tu equipo?
          </p>
        </div>

        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            <CardTitle className="font-headline text-2xl text-center">Abierto a nuevas metas</CardTitle>
            <CardDescription className="text-center text-base pt-1">
              para colaboraciones freelance y desafíos profesionales.
            </CardDescription>
          </CardHeader>
